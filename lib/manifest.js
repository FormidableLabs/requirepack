 ...
 * @param {Object} opts.requirejsRoot   Root of RequireJS build
...
var Manifest = module.exports = function (opts) {
  ...
  var fullBaseUrl = path.resolve(opts.requirejsRoot, rjsCfg.baseUrl);
  this.paths = this._normalizePaths(fullBaseUrl, rjsCfg.paths);
};

/**
 * Normalizes RequireJS path mappings
 *
 * @param {String} baseUrl  RequireJS baseUrl
 * @param {Object} paths    RequireJS path mappings
 * @returns {Object}        Normalized RequireJS path mappings
 */
Manifest.prototype._normalizePaths = function (baseUrl, paths) {
  baseUrl = baseUrl || "./";
...
Manifest.prototype._normalizeContent = function (context, content) {
  // TODO - UNUSED REMOVE? context = context || "./";
